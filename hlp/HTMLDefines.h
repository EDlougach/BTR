...
#define HID_ReadAdd                             0x104CB
#define HID_DATA_GET                            0x18003
#define HID_DATA_STORE                          0x18004
#define HID_VIEW_FITONOFF                       0x18005
#define HID_VIEW_SIZE                           0x18006
#define HID_PLATE_PROPERTIES                    0x1800A
#define HID_PLATE_LOAD                          0x1800B
#define HID_PLATE_SCALE                         0x1800C
#define HID_PLATE_EMIT                          0x1800E
#define HID_PLATE_CLEAR                         0x1800F
#define HID_PLATE_SELECT                        0x18010
#define HID_STOP                                0x18011
#define HID_PLATE_DELETE                        0x18012
#define HID_OPTIONS_STOPIONSAFTERNEUTRALISER    0x18013
#define HID_OPTIONS_ACCOUNTOFREIONIZATION       0x18014
#define HID_OPTIONS_STOPREIONIZEDPARTICLES      0x18015
#define HID_OPTIONS_STRAYFIELDONOFF             0x18016
#define HID_OPTIONS_OPENCALORIMETER             0x18017
#define HID_TASKS_MAGSHIELD                     0x18018
#define HID_TASKS_NEUTRALISATION                0x18019
#define HID_TASKS_REIONIZATION                  0x1801A
#define HID_PLATE_SAVE                          0x1801B
#define HID_RESULTS_SMOOTH                      0x1801C
#define HID_PLATE_SMOOTH                        0x1801D
#define HID_RESULTS_READ                        0x1801E
#define HID_RESULTS_SAVEALL                     0x1801F
#define HID_DATA_DEFAULT                        0x18020
#define HID_DATA_ACTIVE                         0x18021
#define HID_VIEW_ZOOMBOX                        0x18022
#define HID_OPTIONS_REALIONSOURCESTRUCTURE      0x18023
#define HID_DATA_SAVE                           0x18024
#define HID_RESULTS_READALL                     0x18025
#define HID_OPTIONS_DRAW                        0x18026
#define HID_OPTIONS_SINGAP                      0x18027
#define HID_TASKS_RID                           0x18028
#define HID_START                               0x1802D
#define HID_PLATE_SELECTALLPLATES               0x1802E
#define HID_VIEW_FULLAREA                       0x18030
#define HID_TASKS_OTHER                         0x18031
#define HID_VIEW_RID                            0x18032
#define HID_VIEW_NEUTRALISER                    0x18033
#define HID_VIEW_FIELDS                         0x18034
#define HID_VIEW_NUMBERING                      0x18035
#define HID_VIEW_BEAM                           0x18036
#define HID_EDIT_TITLE                          0x18037
#define HID_EDIT_COMMENTS                       0x18038
#define HID_HELP_MANUAL                         0x18039
#define HID_EDIT_MAGFIELD                       0x1803A
#define HID_EDIT_GAS                            0x1803B
#define HID_VIEW_PARTICLES                      0x1803C
#define HID_EDIT_MAGFIELD_7COLUMNS              0x1803D
#define HID_EDIT_MAGFIELD_4COLUMNS              0x1803E
#define HID_EDIT_MAGFIELD_OTHER                 0x1803F
#define HID_PLOT_BEAMLETCURR                    0x18040
#define HID_PLOT_SINGAPARRAY                    0x18041
#define HID_PLOT_SINGAPPOS                      0x18042
#define HID_PLOT_GASPROFILE                     0x18043
#define HID_PLOT_MAGNETICFIELD                  0x18044
#define HID_PLOT_BEAMFOOT                       0x18045
#define HID_PLOT_MAMUGPOSITIONS                 0x18046
#define HID_PLOT_LOADMAP                        0x18047
#define HID_PLOT_3DLOAD                         0x18048
#define HID_PLOT_MAXPROFILES                    0x18049
#define HID_PLOT_BEAMLETFOOT                    0x1804A
#define HID_PLATE_3DPLOT                        0x1804B
#define HID_PLATE_ZOOMIN                        0x1804C
#define HID_PLATE_ZOOMOUT                       0x1804D
#define HID_PLATE_MAXPROFILES                   0x1804E
#define HID_ASK                                 0x1804F
#define HID_TASKS_BEAMPLASMA                    0x18050
#define HID_OPTIONS_TRACENEUTRALSINPLASMA       0x18051
#define HID_PLOT_PENETRATION                    0x18054
#define HID_PLOT_NEUTREFFICIENCY                0x18055
#define HID_PLATE_CONTOURS                      0x18056
#define HID_PLOT_CONTOURS                       0x18057
#define HID_OPTIONS_SURFACES_ADD                0x18058
#define HID_OPTIONS_BEAM                        0x18059
#define HID_OPTIONS_NBICONFIG                   0x1805A
#define HID_OPTIONS_FIELDS                      0x1805B
#define HID_OPTIONS_SURFACES_ENABLEDISABLEALL   0x1805C
#define HID_DATA_IMPORT_PDPSINGAP               0x1805F
#define HID_TASKS_PDPCODE                       0x18062
#define HID_RESULTS_PDPOUTPUT_TABLE             0x18063
#define HID_DATA_IMPORT_SINGAP                  0x18066
#define HID_PDP_BEAMLETS                        0x18067
#define HID_DATA_EXPORT_PDPGEOM                 0x18069
#define HID_DATA_EXPORT_REGULARBEAM             0x1806A
#define HID_Parallel                            0x1806B
#define HID_PLOT_RE                             0x1806C
#define HID_SURFACES_SORTINCR                   0x1806D
#define HID_BUTTON32878                         0x1806E
#define HID_A                                   0x1806F
#define HID_PLOT_COMBINE                        0x18070
#define HID_PLOT_COMBI                          0x18071
#define HID_PLATE_COMBINE                       0x18072
#define HID_PLATE_CL                            0x18073
#define HID_PLATE_CLEARSELECT                   0x18074
#define HID_EDIT_FIRSTWALL                      0x18075
#define HID_FIRSTWALL_2DCONTOUR                 0x18076
#define HID_EDIT_FW_2D                          0x18078
#define HID_SEND_BTRINPUT                       0x18079
#define HID_SEND_OTHER                          0x1807A
#define HID_EDIT_PLASMA                         0x1807B
#define HID_PLASMA_TE                           0x1807C
#define HID_PLASMA_TENE                         0x1807D
#define HID_PLOT_BEAMINPLASMA                   0x1807E
#define HID_BEAMINPLASMA_HORIZONTALPLANE        0x1807F
#define HID_BEAMINPLASMA_VERTICALPLANE          0x18080
#define HID_DATA_SAVEADDSURF                    0x18081
#define HID_DATA_READADDSURF                    0x18082
#define HID_Menu                                0x18083
#define HID_Plasma_PSI                          0x18084
#define HID_TASKS_TRACE                         0x18085
#define HID_TRACEBIGPARTICLE_ATOM               0x18086
#define HID_TRACEBIGPARTICLE_ION                0x18087
#define HID_OPTIONS_PLASMA                      0x18088
#define HID_RESULTS_SAVESUMMARY                 0x18089
#define HID_GASPROFILE_X                        0x1808A
#define HID_GASPROFILE_X32907                   0x1808B
#define HID_OPTIONS_INPUT                       0x1808C
#define HID_INPUT_FREE                          0x1808D
#define HID_INPUT_STANDARD                      0x1808E
#define HID_SURFACES_READ                       0x1808F
#define HID_PLATE_MODIFYSURF                    0x18095
#define HID_PLATE_DELETEALLFREE                 0x18096
#define HID_PLATE_SHO                           0x18097
#define HID_PLATE_FILE                          0x18098
#define HID_PLOT_RE32921                        0x18099
#define HID_PLOT_REION                          0x1809A
#define HID_OPTIONS_THREADS                     0x1809B
#define HID_PD_REIONS                           0x1809C
#define HID_PD_ATOMS                            0x1809D
#define HID_PLOT_ANGULARDISTR                   0x1809E
#define HID_NEUTRALIZATION_CURRENTS             0x1809F
#define HID_NEUTRALIZATION_RATES                0x180A0
#define HID_TRACEBIGPARTICLE_ELECTRON           0x180A1
#define HID_DATA_LOG                            0x180A2
#define HID_LOG_VIEW                            0x180A3
#define HID_LOG_SAVE                            0x180A4
#define HID_DATA_STATISTICS                     0x180A5
#define HID_STATISTICS_VIEW                     0x180A6
#define HID_STATISTICS_SET                      0x180A7
#define HID_SURFACES_STEPPREF                   0x180A8
#define HID_SURFACES_MESH                       0x180A9
#define HID_PLATE_LOADOPT                       0x180AA
#define HID_PLATE_CLEARALL                      0x180AB
#define HID_EDIT_CROSS                          0x180AC
#define HID_BEAMINPLASMA_POLOIDALR              0x180AD
#define HID_BEAMINPLASMA_POL_RZ                 0x180AE
...
#define HIDR_BTRTYPE                            0x20081
#define HIDR_MENUPOP                            0x20086
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_PROJECTBAR                         0x20067
#define HIDD_ViewSize_Dlg                       0x20082
#define HIDD_LoadStep_Dlg                       0x20087
#define HIDD_Remn_Dlg                           0x20088
#define HIDD_Reion_Dlg                          0x20089
#define HIDD_Neutr_Dlg                          0x2008A
#define HIDD_Res_Smooth                         0x2008B
#define HIDD_IonSource_Dlg                      0x2008C
#define HIDD_Task_Dlg                           0x2008D
#define HIDD_CommentsDlg                        0x2008E
#define HIDD_Gas_Dlg                            0x2008F
#define HIDD_MF_Dlg                             0x20090
#define HIDD_PLOT_Dlg                           0x20091
#define HIDD_PREVIEW_Dlg                        0x20092
#define HIDD_ASK_Dlg                            0x20094
#define HIDD_Inject_Dlg                         0x20095
#define HIDD_Surf_Dlg                           0x20096
#define HIDD_Fields_Dlg                         0x20097
#define HIDD_NBI_Dlg                            0x20098
#define HIDD_Beam_Dlg                           0x20099
#define HIDD_Beamlet                            0x2009A
#define HIDD_Particles_Dlg                      0x2009B
#define HIDD_Thick_Dlg                          0x2009C
#define HIDD_Thin_Dlg                           0x2009D
#define HIDD_MPLOT_Dlg                          0x2009E
#define HIDD_Threads_Dlg                        0x2009F
#define HIDD_Contours_Dlg                       0x200A0
#define HIDD_RID_Dlg                            0x200A1
#define HIDD_ATOM_Dlg                           0x200A2
#define HIDD_Plasma_Dlg                         0x200A3
#define HIDD_Num_DLG                            0x200A4
#define HIDD_INPUT_DLG                          0x200A6
#define HIDD_AddGas_Dlg                         0x200A7
#define HIDD_START_DLG                          0x200A8
#define HIDD_Limits_Dlg                         0x200A9
#define HIDD_DefLoad_Dlg                        0x200AD
#define HIDD_StatOptDlg                         0x200AF
